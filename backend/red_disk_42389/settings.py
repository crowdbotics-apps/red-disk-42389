"""
Django settings for red_disk_42389 project.
...
ROOT_URLCONF = 'red_disk_42389.urls'
...
WSGI_APPLICATION = 'red_disk_42389.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_disk_42389 API",
    "DESCRIPTION": "API documentation for red_disk_42389 App",
    "VERSION": "v1",
}
